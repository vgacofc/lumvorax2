...
2026-04-28 12:25 - C113-CMD-UBUNTU-FIX + C113 — Correction commande Ubuntu fournie en C112 : chemin '~/Lumvorax/lumvorax2/' incorrect (alias utilisateur reel = '~/L/lumvorax2/'), faisait basculer make -B sur Makefile racine ; commande corrigee utilise '~/L/lumvorax2/...' + separateurs ';' (stop-on-fail) en fish
