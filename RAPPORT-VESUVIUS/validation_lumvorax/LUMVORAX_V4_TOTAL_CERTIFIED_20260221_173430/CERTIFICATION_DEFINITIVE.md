...
Date: Sat Feb 21 05:34:31 PM UTC 2026
...
## 2. Analyse du Rapport de Conformité
{
  ...
  "timestamp_ns": 1771695214519734553,
  "runtime": {
  ...
  "events": [
    {
      "ts_ns": 1771695214519804856,
      "step": "dependency_already_installed",
      "package": "numpy"
    },
    {
      "ts_ns": 1771695214726261462,
      "step": "dependency_already_installed",
      "package": "tifffile"
    },
    {
      "ts_ns": 1771695214730299190,
    ...
    {
      "ts_ns": 1771695219554030520,
      "step": "dependency_install_ok",
      "package": "imagecodecs",
      "root": "/kaggle/input/datasets/ndarray2000/nx47-dependencies"
    },
    {
      "ts_ns": 1771695219581869836,
    ...
    {
      "ts_ns": 1771695219591153143,
      "step": "source_dir_missing",
      "directory": "/kaggle/working/src/lum"
    },
    {
      "ts_ns": 1771695219591163638,
      "step": "source_dir_missing",
      "directory": "/kaggle/working/src/file_formats"
    },
    {
      "ts_ns": 1771695219591172703,
      "step": "source_dir_missing",
      "directory": "/kaggle/working/src/vorax"
    },
    {
      "ts_ns": 1771695219591181685,
      "step": "source_dir_missing",
      "directory": "/kaggle/working/src/logger"
    },
    {
      "ts_ns": 1771695219591190137,
      "step": "source_dir_missing",
      "directory": "/kaggle/working/src/debug"
    },
    {
      "ts_ns": 1771695219591201662,
      "step": "source_dir_missing",
      "directory": "src/lum"
    },
    {
      "ts_ns": 1771695219591211032,
      "step": "source_dir_missing",
      "directory": "src/file_formats"
    },
    {
      "ts_ns": 1771695219591218755,
      "step": "source_dir_missing",
      "directory": "src/vorax"
    },
    {
      "ts_ns": 1771695219591225833,
      "step": "source_dir_missing",
      "directory": "src/logger"
    },
    {
      "ts_ns": 1771695219591232848,
      "step": "source_dir_missing",
      "directory": "src/debug"
    },
    {
      "ts_ns": 1771695219591234076,
      "step": "header_scan_done",
      "headers": 0,
      "functions": 0
    },
    {
      "ts_ns": 1771695219591240766,
      "step": "fatal_error",
  ...
  "error_type": "RuntimeError",
  "error": "no_native_headers_found",
  "elapsed_ns": 5071508464,
  "elapsed_s": 5.071508464
}
