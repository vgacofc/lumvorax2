...
- **Lignes de code**: 4996
- **SHA256 du code**: 41187e3e11d24a12dd6b5cf37c0f2948f0609064081feb0289bc1557d342eb39
- **Timestamp**: 2026-06-06T19:48:39.417Z

## Code Source à Analyser

Le code source complet est disponible dans le fichier :
`/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-tasks/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e/source-code-complete.txt`
...
```json
{
  "stdout": "[MDBAI-RUNNER] ========================================\n[MDBAI-RUNNER] Job ID    : mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e\n[MDBAI-RUNNER] Repo Dir  : /tmp/mdbai-analysis/repo_36b03e44-ac5e-48de-9371-a15c77e1bbd0\n[MDBAI-RUNNER] Exec Cmd  : python -m pytest -v --tb=short 2>&1 || python -m unittest discover 2>&1 || python3 -c 'import py_compile,glob; [py_compile.compile(f,doraise=True) for f in glob.glob(\"**/*.py\",recursive=True) if \".ccls\" not in f]' 2>&1 || true\n[MDBAI-RUNNER] Log File  : /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/logger/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e_forensic.log\n[MDBAI-RUNNER] Mem File  : /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/memory/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e_memory.lum\n[MDBAI-RUNNER] LD_PRELOAD: /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/libmdbai_forensic.so\n[MDBAI-RUNNER] Timestamp : 2026-06-06T21-48-38\n[MDBAI-RUNNER] ========================================\n[MDBAI-RUNNER] Métriques pré-exécution...\n[MDBAI-RUNNER] Exécution: python -m pytest -v --tb=short 2>&1 || python -m unittest discover 2>&1 || python3 -c 'import py_compile,glob; [py_compile.compile(f,doraise=True) for f in glob.glob(\"**/*.py\",recursive=True) if \".ccls\" not in f]' 2>&1 || true\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e\nbash: line 1: python: command not found\n[MDBAI-FORENSIC] events=0 snapshots=2\nbash: line 1: python: command not found\n[MDBAI-FORENSIC] events=0 snapshots=2\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e\nTraceback (most recent call last):\n  File \"/usr/lib/python3.12/py_compile.py\", line 144, in compile\n    code = loader.source_to_code(source_bytes, dfile or file,\n           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"<frozen importlib._bootstrap_external>\", line 1059, in source_to_code\n  File \"<frozen importlib._bootstrap>\", line 488, in _call_with_frames_removed\n  File \"vgac_native/tests/test_vgac.py\", line 36\n    ∇ = self.core.consciousness.create_state(level=2)\n    ^\nSyntaxError: invalid character '∇' (U+2207)\n\nDuring handling of the above exception, another exception occurred:\n\nTraceback (most recent call last):\n  File \"<string>\", line 1, in <module>\n  File \"/usr/lib/python3.12/py_compile.py\", line 150, in compile\n    raise py_exc\npy_compile.PyCompileError:   File \"vgac_native/tests/test_vgac.py\", line 36\n    ∇ = self.core.consciousness.create_state(level=2)\n    ^\nSyntaxError: invalid character '∇' (U+2207)\n\n[MDBAI-FORENSIC] events=0 snapshots=2\n[MDBAI-FORENSIC] events=0 snapshots=2\n[MDBAI-RUNNER] Exit code: 0\n[MDBAI-RUNNER] Durée: 697ms\n[MDBAI-RUNNER] Log: /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/logger/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e_forensic.log (7942 octets)\n[MDBAI-RUNNER] Mem: /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/memory/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e_memory.lum (1856 octets)\n[MDBAI-RUNNER] Terminé ✅\n",
  "stderr": "",
  "stdout_file": "/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/execution/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e_stdout.log",
  "stderr_file": "/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/execution/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e_stderr.log",
  "exit_code": 0,
  "memory_leaks": [],
  "syscalls": [],
  "cpu_percent": 82,
  "memory_bytes": 71303168,
  "io_read_mb": 7,
  "io_write_mb": 0,
  "duration_ms": 796,
  "lum_snapshots": [
    {
      "file": "/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/memory/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e_memory.lum",
      "size_bytes": 2048,
      "magic": "0x4D444241",
      "type": "memory"
    }
...
```json
{
  "analysis_metadata": {
    ...
    "files_analyzed": 39,
    "lines_analyzed": 4996,
    "source_sha256": "41187e3e11d24a12dd6b5cf37c0f2948f0609064081feb0289bc1557d342eb39"
  },
  "errors": [
    {
...
1. **Analyse JSON**: `/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-analysis/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e/bob-analysis.json`
2. **Rapport Markdown**: `/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-analysis/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e/bob-report.md`
3. **Logs d'exécution**: `/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-analysis/mdbai-da3caa17-ba09-4d52-9507-8f02fefa0c8e/bob-execution.log`
