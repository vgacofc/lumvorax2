...
## Contexte
- **Job ID**: mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8
- **Langage**: python
- **Fichiers analysés**: 39
- **Lignes de code**: 4996
- **SHA256 du code**: 0b5f7ba9935397ac141046d286b99fe2f78e03d2599dace7f72d4299cf5fb5a6
- **Timestamp**: 2026-06-06T21:32:28.508Z

## Code Source à Analyser

Le code source complet est disponible dans le fichier :
`/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-tasks/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8/source-code-complete.txt`
...
```json
{
  "stdout": "[MDBAI-RUNNER] ========================================\n[MDBAI-RUNNER] Job ID    : mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8\n[MDBAI-RUNNER] Repo Dir  : /tmp/mdbai-analysis/repo_0a0489ad-213e-4929-af56-98022ebc1bea\n[MDBAI-RUNNER] Exec Cmd  : python -m pytest -v --tb=short 2>&1 || python -m unittest discover 2>&1 || python3 -c 'import py_compile,glob; [py_compile.compile(f,doraise=True) for f in glob.glob(\"**/*.py\",recursive=True) if \".ccls\" not in f]' 2>&1 || true\n[MDBAI-RUNNER] Log File  : /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/logger/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8_forensic.log\n[MDBAI-RUNNER] Mem File  : /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/memory/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8_memory.lum\n[MDBAI-RUNNER] LD_PRELOAD: /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/libmdbai_forensic.so\n[MDBAI-RUNNER] Timestamp : 2026-06-06T23-32-27\n[MDBAI-RUNNER] ========================================\n[MDBAI-RUNNER] Métriques pré-exécution...\n[MDBAI-RUNNER] Exécution: python -m pytest -v --tb=short 2>&1 || python -m unittest discover 2>&1 || python3 -c 'import py_compile,glob; [py_compile.compile(f,doraise=True) for f in glob.glob(\"**/*.py\",recursive=True) if \".ccls\" not in f]' 2>&1 || true\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8\nbash: line 1: python: command not found\n[MDBAI-FORENSIC] events=0 snapshots=2\nbash: line 1: python: command not found\n[MDBAI-FORENSIC] events=0 snapshots=2\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8\nTraceback (most recent call last):\n  File \"/usr/lib/python3.12/py_compile.py\", line 144, in compile\n    code = loader.source_to_code(source_bytes, dfile or file,\n           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"<frozen importlib._bootstrap_external>\", line 1059, in source_to_code\n  File \"<frozen importlib._bootstrap>\", line 488, in _call_with_frames_removed\n  File \"vgac_native/tests/test_vgac.py\", line 36\n    ∇ = self.core.consciousness.create_state(level=2)\n    ^\nSyntaxError: invalid character '∇' (U+2207)\n\nDuring handling of the above exception, another exception occurred:\n\nTraceback (most recent call last):\n  File \"<string>\", line 1, in <module>\n  File \"/usr/lib/python3.12/py_compile.py\", line 150, in compile\n    raise py_exc\npy_compile.PyCompileError:   File \"vgac_native/tests/test_vgac.py\", line 36\n    ∇ = self.core.consciousness.create_state(level=2)\n    ^\nSyntaxError: invalid character '∇' (U+2207)\n\n[MDBAI-FORENSIC] events=0 snapshots=2\n[MDBAI-FORENSIC] events=0 snapshots=2\n[MDBAI-RUNNER] Exit code: 0\n[MDBAI-RUNNER] Durée: 910ms\n[MDBAI-RUNNER] Log: /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/logger/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8_forensic.log (7942 octets)\n[MDBAI-RUNNER] Mem: /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/memory/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8_memory.lum (1856 octets)\n[MDBAI-RUNNER] Terminé ✅\n",
  "stderr": "",
  "stdout_file": "/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/execution/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8_stdout.log",
  "stderr_file": "/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/execution/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8_stderr.log",
  "exit_code": 0,
  "memory_leaks": [],
  "syscalls": [],
  "cpu_percent": 66,
  ...
  "lum_snapshots": [
    {
      "file": "/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/memory/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8_memory.lum",
      "size_bytes": 2048,
      "magic": "0x4D444241",
      "type": "memory"
    }
...
```json
{
  "analysis_metadata": {
    ...
    "files_analyzed": 39,
    "lines_analyzed": 4996,
    "source_sha256": "0b5f7ba9935397ac141046d286b99fe2f78e03d2599dace7f72d4299cf5fb5a6"
  },
  "errors": [
    {
...
1. **Analyse JSON**: `/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-analysis/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8/bob-analysis.json`
2. **Rapport Markdown**: `/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-analysis/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8/bob-report.md`
3. **Logs d'exécution**: `/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-analysis/mdbai-bf79126d-5a13-410c-9a7f-76abca43e5d8/bob-execution.log`
