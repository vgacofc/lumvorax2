...
## Contexte
- **Job ID**: mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0
- **Langage**: nodejs
- **Fichiers analysés**: 18
- **Lignes de code**: 1163
- **SHA256 du code**: 2cec45ca091f52086dc38a30b09d88fe9e66ef9d828a504b7799978a49bced5b
- **Timestamp**: 2026-06-06T00:51:31.818Z
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/analytics/static/js/dashboard.js
// LINES: 190
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/frontend/package.json
// LINES: 96
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/frontend/src/App.js
// LINES: 27
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/frontend/src/index.js
// LINES: 11
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/frontend/src/locales/fr/dashboard.json
// LINES: 57
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/frontend/src/locales/fr/insights.json
// LINES: 51
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/frontend/src/locales/fr/leaderboard.json
// LINES: 29
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/frontend/src/locales/fr/timeline.json
// LINES: 27
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/frontend/tests/unit/gamification/Dashboard.spec.js
// LINES: 85
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/frontend/tests/unit/gamification/LeaderboardWidget.spec.js
// LINES: 85
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/sdk/javascript/package.json
// LINES: 37
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/sdk/javascript/src/client.ts
// LINES: 123
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/sdk/javascript/src/exceptions.ts
// LINES: 42
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/sdk/javascript/src/index.ts
// LINES: 4
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/sdk/javascript/src/models.ts
// LINES: 96
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/sdk/javascript/tsconfig.json
// LINES: 18
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/help_platform/web_admin/static/js/dashboard.js
// LINES: 178
// ========================================
...
// ========================================
// FILE: /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/package-lock.json
// LINES: 7
// ========================================

{
  "name": "repo_50bedfc0-de78-4bab-83a1-7961fef23428",
  "lockfileVersion": 3,
  "requires": true,
  "packages": {}
}
...
```json
{
  "stdout": "[MDBAI-RUNNER] ========================================\n[MDBAI-RUNNER] Job ID    : mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0\n[MDBAI-RUNNER] Repo Dir  : /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428\n[MDBAI-RUNNER] Exec Cmd  : npm test 2>&1 || npm run build 2>&1 || true\n[MDBAI-RUNNER] Log File  : /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/logger/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0_forensic.log\n[MDBAI-RUNNER] Mem File  : /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/memory/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0_memory.lum\n[MDBAI-RUNNER] LD_PRELOAD: /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/libmdbai_forensic.so\n[MDBAI-RUNNER] Timestamp : 2026-06-06T02-51-27\n[MDBAI-RUNNER] ========================================\n[MDBAI-RUNNER] Métriques pré-exécution...\n[MDBAI-RUNNER] Exécution: npm test 2>&1 || npm run build 2>&1 || true\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0\nnpm ERR! code ENOENT\nnpm ERR! syscall open\nnpm ERR! path /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/package.json\nnpm ERR! errno -2\nnpm ERR! enoent ENOENT: no such file or directory, open '/tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/package.json'\nnpm ERR! enoent This is related to npm not being able to find a file.\nnpm ERR! enoent \n\nnpm ERR! A complete log of this run can be found in:\nnpm ERR!     /home/lvx/.npm/_logs/2026-06-06T00_51_29_343Z-debug-0.log\n[MDBAI-FORENSIC] events=0 snapshots=2\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0\n[MDBAI-FORENSIC] Initialisé via LD_PRELOAD job=mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0\nnpm ERR! code ENOENT\nnpm ERR! syscall open\nnpm ERR! path /tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/package.json\nnpm ERR! errno -2\nnpm ERR! enoent ENOENT: no such file or directory, open '/tmp/mdbai-analysis/repo_50bedfc0-de78-4bab-83a1-7961fef23428/package.json'\nnpm ERR! enoent This is related to npm not being able to find a file.\nnpm ERR! enoent \n\nnpm ERR! A complete log of this run can be found in:\nnpm ERR!     /home/lvx/.npm/_logs/2026-06-06T00_51_31_497Z-debug-0.log\n[MDBAI-FORENSIC] events=0 snapshots=2\n[MDBAI-FORENSIC] events=0 snapshots=2\n[MDBAI-RUNNER] Exit code: 0\n[MDBAI-RUNNER] Durée: 4505ms\n[MDBAI-RUNNER] Log: /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/logger/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0_forensic.log (8324 octets)\n[MDBAI-RUNNER] Mem: /home/lvx/LVX/lumvorax2/src/MDBAI/forensic/memory/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0_memory.lum (1984 octets)\n[MDBAI-RUNNER] Terminé ✅\n",
  "stderr": "",
  "stdout_file": "/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/execution/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0_stdout.log",
  "stderr_file": "/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/execution/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0_stderr.log",
  "exit_code": 0,
  "memory_leaks": [],
  "syscalls": [],
  "cpu_percent": 87,
  "memory_bytes": 97517568,
  "io_read_mb": 0,
  "io_write_mb": 0,
  "duration_ms": 4622,
  "lum_snapshots": [
    {
      "file": "/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/memory/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0_memory.lum",
      "size_bytes": 2176,
      "magic": "0x4D444241",
      "type": "memory"
    }
...
```json
{
  "analysis_metadata": {
    ...
    "files_analyzed": 18,
    "lines_analyzed": 1163,
    "source_sha256": "2cec45ca091f52086dc38a30b09d88fe9e66ef9d828a504b7799978a49bced5b"
  },
  "errors": [
    {
...
1. **Analyse JSON**: `/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-analysis/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0/bob-analysis.json`
2. **Rapport Markdown**: `/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-analysis/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0/bob-report.md`
3. **Logs d'exécution**: `/home/lvx/LVX/lumvorax2/src/MDBAI/forensic/bob-analysis/mdbai-67ad3bd6-9780-475e-b325-b481ea2ec0a0/bob-execution.log`
