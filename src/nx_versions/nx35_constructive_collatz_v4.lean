...
Version 100% constructive : Ω_non_dec et μ_impl_collatz avec logs persistés
-/
...
-- Descente constructible avec fonction concrète f
...
-- Exemple de fonction μ concrète : Collatz step
def μ_collatz_step : μ := collatz_step
...
def log_json (n k : Nat) : Lean.Json :=
  Lean.Json.arr (Array.ofList (log_iter n k |>.map Lean.Json.str))
...
#eval log_iter 7 5
#eval log_json 7 5
#eval descend μ_collatz_step 7 0
