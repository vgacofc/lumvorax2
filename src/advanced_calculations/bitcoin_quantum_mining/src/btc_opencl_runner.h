...
/* C286: Batch 10M nonces (C283 validé: 100/100 dispatches OK, 40 GH/s pic) */
#define BTC_OCL_BATCH_DEFAULT (10000000u)  /* 10M nonces (C283: 2.506 GH/s moyen, 42.19 GH/s pic) */
