...
/* Batch size par défaut (compatible OpenCL) */
#define BTC_OCL_BATCH_DEFAULT 262144  /* 256K nonces/dispatch */
...
typedef struct {
    ...
    /* Buffers double-buffering (pipeline async) */
    #define GEN9_BUFFER_COUNT 2
    struct {
