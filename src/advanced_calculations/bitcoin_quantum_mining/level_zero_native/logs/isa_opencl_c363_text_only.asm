...
(W)     mov (8|M0)               r127.0<1>:ud  r3.0<8;8,1>:ud                   {Compacted}
        ...
        sends (16|M0)            null:w   r5      r11     0x8C            0x04025E00           // wr:2+2, rd:0; hdc.dc1; untyped surface write with x
        sends (16|M16)           null:w   r9      r13     0x8C            0x04025E00           // wr:2+2, rd:0; hdc.dc1; untyped surface write with x
