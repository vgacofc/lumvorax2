...
int main() {
    ...
    printf("[9%%] ✓ Heap BO créé (handle=%u)\n", heap_handle);
    ...
    printf("[11%%] ✓ Output BO créé (handle=%u)\n", output_handle);
    ...
    // Lire adresses GTT PASS 1
    uint64_t heap_gtt_pass1 = objects_pass1[0].offset;
    ...
    // Lire nouvelle adresse heap
    uint64_t heap_gtt = objects_pass2a[0].offset;
    
    printf("[55%%] ✓ PASS 2A RÉUSSI!\n");
    printf("       Heap final:   0x%016lx\n", heap_gtt);
    ...
    struct drm_i915_gem_exec_object2 objects_pass2b[3] = {
        {
            ...
            .offset = heap_gtt  // ✅ Adresse valide obtenue en PASS 2A
        },
        {
            .handle = output_handle,
