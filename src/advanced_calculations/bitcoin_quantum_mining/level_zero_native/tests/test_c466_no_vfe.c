/*
 * TEST C466 - SANS MEDIA_VFE_STATE (PRIORITÉ #1)
 * 
 * Objectif: Isoler si le problème est dans VFE ou SBA MOCS
 * 
 * Contenu:
 ...
 * - IDD
 * 
 * Si réussi → VFE est ROOT CAUSE
 * Si échec → SBA MOCS est ROOT CAUSE
 */
...
int main(void) {
    FORENSIC_LOG("🚀 TEST C466 - SANS MEDIA_VFE_STATE (PRIORITÉ #1)");
    ...
    /* Construire batch buffer SANS VFE */
    ...
    FORENSIC_LOG("📊 SANS MEDIA_VFE_STATE - Test isolation VFE");
    ...
    FORENSIC_LOG("⚡ Soumission batch (SANS VFE)...");
    ...
    FORENSIC_LOG("🎉 TEST C466 RÉUSSI - GPU fonctionne SANS VFE!");
    FORENSIC_LOG("📊 CONCLUSION: MEDIA_VFE_STATE était ROOT CAUSE!");
