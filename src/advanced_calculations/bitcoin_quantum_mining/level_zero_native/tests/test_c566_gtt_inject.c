// test_c566_gtt_inject.c - CORRECTION ROOT CAUSE #78
// Injection adresse GTT explicite dans batch buffer
// Cycle C566 - 2026-05-25 18:14 CET
...
int main() {
    printf("=== TEST C566 - INJECTION GTT EXPLICITE ===\n");
    printf("ROOT CAUSE #78: Relocation ne fonctionne pas dans batch\n");
    printf("CORRECTION: Injecter output_gtt APRÈS PASS 1\n\n");
