// C424: Test SIMD1 MINIMAL - 1 thread, 1 lane, 1 write
...
int main(void) {
    printf("\n");
    printf("╔════════════════════════════════════════════════════════════╗\n");
    printf("║  C424 TEST - SIMD1 MINIMAL (Intel PRM Descriptor)        ║\n");
    printf("║  1 thread, 1 lane, 1 write - Validation dataport         ║\n");
    printf("╚════════════════════════════════════════════════════════════╝\n");
    printf("\n");

    LOG_NS("C424 START - SIMD1 Minimal Test");
    ...
    FILE* f = fopen("kernels/btc_simd1_minimal_c424.bin", "rb");
    if (!f) {
    ...
    LOG_NS("Executing C424 with SIMD1 minimal...");
    ...
    if (valid_count > 0) {
        ...
        LOG_NS("C424 SUCCESS - First GPU write validated!");
    } else {
        ...
        LOG_NS("C424 FAILED - SIMD1 still produces 0 writes");
    }
