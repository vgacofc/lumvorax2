/*
 * TEST C588 - AJOUT MEDIA_PIPELINE_SELECT SUR BASE C584 FONCTIONNELLE
 *
 * BASE: C584 qui fonctionne (EXECBUFFER2 SUCCESS + Context)
...
#define GEN9_MEDIA_PIPELINE_SELECT  0x69040000  // NOUVEAU C588
...
int main(void) {
    ...
    printf("🚀 TEST C588 - CONTEXT + MEDIA_PIPELINE_SELECT (BASE C584)\n");
    printf("═══════════════════════════════════════════════════════════════════════\n");
    printf("BASE: C584 fonctionnel (Context + Relocations)\n");
    printf("AJOUT: MEDIA_PIPELINE_SELECT avant MEDIA_VFE_STATE\n");
    printf("═══════════════════════════════════════════════════════════════════════\n\n");
    ...
    /* 3. MEDIA_PIPELINE_SELECT (GPGPU) - 1 DWord */
    printf("    [%2d] MEDIA_PIPELINE_SELECT (GPGPU)\n", offset);
