// TEST C563 - CORRECTION ROOT CAUSE #74: RETIRER EXEC_OBJECT_PINNED POUR OUTPUT
// Objectif: Permettre i915 d'allouer GTT automatiquement pour output
// Référence: C562 - ROOT CAUSE #74 identifié (GTT=0x0 + PINNED invalide)
// Stratégie: Seuls heap et batch sont PINNED, output utilise relocation automatique
...
int main() {
    printf("=== TEST C563 - CORRECTION ROOT CAUSE #74 ===\n");
    printf("ROOT CAUSE #74: GTT=0x0 + EXEC_OBJECT_PINNED invalide\n");
    printf("CORRECTION: Retirer EXEC_OBJECT_PINNED pour output, permettre relocation auto\n\n");
    ...
    printf("STRATÉGIE C563: Output → Heap → Batch (output NON-PINNED)\n");
    ...
    // === PASS 2: EXÉCUTION GPU FINALE SANS PINNED POUR OUTPUT ===
    printf("\n=== PASS 2: EXÉCUTION GPU FINALE (90%%) ===\n");
    printf("STRATÉGIE: Output NON-PINNED, heap+batch PINNED\n");
    ...
    printf("[92%%] Soumission PASS 2 (output NON-PINNED)...\n");
