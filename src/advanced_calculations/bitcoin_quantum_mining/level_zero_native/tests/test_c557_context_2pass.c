// TEST C557 - CORRECTION ROOT CAUSE #64: CONTEXT i915 + STRATÉGIE 2-PASS
// Objectif: Créer context i915, PASS 1 batch minimal, PASS 2 batch complet
// Référence: SOLUTION_DRM.md - ROOT CAUSE #63, #64
...
int main() {
    printf("=== TEST C557 - CONTEXT i915 + STRATÉGIE 2-PASS ===\n");
    printf("ROOT CAUSE #64: Context i915 requis pour execbuffer2\n");
    printf("ROOT CAUSE #63: PASS 1 minimal, PASS 2 complet\n\n");
    ...
    printf("[35%%] Soumission PASS 1 (avec context %u)...\n", context_id);
    ...
    printf("[49%%] ✓ IDRT patché (kernel @ 0x%016lx)\n", kernel_gtt);
    
    // === CONSTRUCTION BATCH COMPLET ===
    printf("\n=== CONSTRUCTION BATCH COMPLET (51%%) ===\n");
    ...
    printf("[53%%] ✓ PIPELINE_SELECT\n");
    
    // STATE_BASE_ADDRESS (19 DWords) avec GTT
    ...
    printf("[55%%] ✓ STATE_BASE_ADDRESS (heap GTT)\n");
    ...
    printf("[65%%] ✓ MEDIA_INTERFACE_DESCRIPTOR_LOAD\n");
    ...
    batch[idx++] = 0x00000000;  // Reserved
    printf("[70%%] ✓ GPGPU_WALKER (1 work-item)\n");
    
    // MEDIA_STATE_FLUSH
    batch[idx++] = 0x70040000;
    printf("[75%%] ✓ MEDIA_STATE_FLUSH\n");
    ...
    printf("[91%%] Soumission PASS 2 (batch complet)...\n");
