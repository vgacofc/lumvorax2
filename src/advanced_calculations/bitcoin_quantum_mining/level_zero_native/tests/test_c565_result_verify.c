// test_c565_result_verify.c - CORRECTION ROOT CAUSE #77
// Vérification résultat GPU AVANT munmap
// Cycle C565 - 2026-05-25 18:12 CET
...
int main() {
    printf("=== TEST C565 - VÉRIFICATION RÉSULTAT GPU ===\n");
    printf("ROOT CAUSE #77: Accès output après munmap\n");
    printf("CORRECTION: Sauvegarder résultat AVANT cleanup\n\n");
    ...
    struct drm_i915_gem_execbuffer2 execbuf_pass2 = {
        ...
        .buffer_count = 3,
        .batch_start_offset = 0,
        .batch_len = batch_complet_len,  // ✅ Aligné 8 bytes
        .flags = I915_EXEC_RENDER,
        .rsvd1 = context_id,
        .rsvd2 = 0
    };
    ...
    // === ✅ CORRECTION ROOT CAUSE #77: VÉRIFICATION RÉSULTAT AVANT MUNMAP ===
...
// Made with Bob - Cycle C565
// ROOT CAUSE #77: Accès output après munmap → RÉSOLU
