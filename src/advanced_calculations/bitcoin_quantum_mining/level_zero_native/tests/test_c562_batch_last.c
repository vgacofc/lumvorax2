...
// Stratégie: Retirer flag I915_EXEC_NO_RELOC pour compatibilité buffers non-PINNED
...
int main() {
    printf("=== TEST C561 - CORRECTION ROOT CAUSE #69 ===\n");
    printf("ROOT CAUSE #69: I915_EXEC_NO_RELOC incompatible avec non-PINNED\n");
    printf("CORRECTION: Retirer flag I915_EXEC_NO_RELOC\n\n");
    ...
    printf("STRATÉGIE C561: Output → Heap → Batch (batch EN DERNIER)\n");
    ...
    // === PASS 2: EXÉCUTION GPU FINALE SANS NO_RELOC ===
    printf("\n=== PASS 2: EXÉCUTION GPU FINALE (90%%) ===\n");
    printf("STRATÉGIE: Retirer I915_EXEC_NO_RELOC, permettre relocations\n");
    
    // ✅ CORRECTION ROOT CAUSE #73: TOUS les buffers PINNED avec GTT non-NULL
    struct drm_i915_gem_exec_object2 objects_pass2[3] = {
        {
            ...
            .offset = output_gtt  // ✅ PINNED à GTT=0x0 (testé explicitement)
        },
        {
            .handle = heap_handle,
    ...
    fprintf(stderr, "[DEBUG]   flags = I915_EXEC_RENDER (SANS NO_RELOC) ✅\n");
    fprintf(stderr, "[DEBUG]   batch_len = %u bytes\n", batch_complet_len);
    
    printf("[92%%] Soumission PASS 2 (SANS I915_EXEC_NO_RELOC)...\n");
