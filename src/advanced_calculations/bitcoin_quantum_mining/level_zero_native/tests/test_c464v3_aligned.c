/*
 * TEST C464v3 - BATCH MINIMAL AVEC ALIGNEMENT 8-BYTE
 * ROOT CAUSE: batch_len DOIT être aligné sur 8 bytes
 * Ligne 2203 i915_gem_execbuffer.c:
...
int main(void) {
    FORENSIC_LOG("🚀 TEST C464v3 - BATCH MINIMAL AVEC ALIGNEMENT 8-BYTE");
    ...
    FORENSIC_LOG("🎉 TEST C464v3 RÉUSSI - Batch minimal fonctionne avec alignement 8-byte!");
