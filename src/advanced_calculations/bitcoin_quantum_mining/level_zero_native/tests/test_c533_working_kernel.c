// TEST C533 - ROOT CAUSE #38: KERNEL FONCTIONNEL OPENCL
// Le kernel C491 était DÉFECTUEUX - utilisation du kernel C532 qui fonctionne
// Kernel extrait d'OpenCL qui produit output[0] = 0x12345678 correctement
...
#include <i915_drm.h>
#include "test_c533_working_kernel.h"
...
int main(void) {
    printf("\n╔════════════════════════════════════════════════════════════════╗\n");
    printf("║  TEST C533 - KERNEL FONCTIONNEL (ROOT CAUSE #38)            ║\n");
    printf("╚════════════════════════════════════════════════════════════════╝\n\n");
    printf("ROOT CAUSE #38: Le kernel C491 était DÉFECTUEUX\n");
    printf("Solution: Utiliser le kernel C532 extrait d'OpenCL qui fonctionne\n");
    printf("Kernel C532: 2952 bytes, testé avec OpenCL = SUCCESS\n\n");
    ...
    // [4/15] Init output + kernel FONCTIONNEL C532
    printf("[4/15] Initialisation output + kernel FONCTIONNEL C532...\n");
    ...
    memcpy(kernel_bo->virtual, kernel_working, kernel_working_size);
    drm_intel_bo_unmap(kernel_bo);
    printf("  ✓ Output et kernel FONCTIONNEL initialisés (%zu bytes)\n\n", kernel_working_size);
