...
int main() {
    ...
    struct drm_i915_gem_exec_object2 objects_pass2[3] = {
        ...
        },
        {
            .handle = output_handle,
            .flags = EXEC_OBJECT_SUPPORTS_48B_ADDRESS | EXEC_OBJECT_WRITE,
            .offset = 0  // ✅ PAS PINNED, i915 choisit
        }
    };
    ...
    struct drm_i915_gem_execbuffer2 execbuf_pass2 = {
        ...
        .buffer_count = 3,
        .batch_start_offset = 0,  // ✅ Début du buffer objects_pass2[0] (batch)
        .batch_len = batch_complet_len,
        .flags = I915_EXEC_RENDER | I915_EXEC_BATCH_FIRST,  // ✅ Batch à l'index 0!
        .rsvd1 = context_id,
        .rsvd2 = 0
    };
