...
int main(int argc, char** argv) {
    ...
    /* Seuils calibres en eV/site — references qmc_dmrg_reference_v2.csv converties de meV-total a eV/site */
    ...
    /* Seuils calibres en eV/site — references external_module_benchmarks_v1.csv converties a eV/site */
