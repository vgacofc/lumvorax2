# STANDARD_NAMES.md — Registre canonique des noms du module Hubbard-HTS

**Version :** 4.2 — 2026-04-12 (C38 : §M-BTC17-C38 ajouté — label 256 bits, B-NX48 stall_count, vrais POW BTC, option --header-hex)
**Langue obligatoire :** TOUJOURS répondre et rédiger EN FRANÇAIS dans cette session de chat.

> **NOTE IMPORTANTE** : Ce fichier est spécifique au module Hubbard-HTS.
> Pour le registre GLOBAL de tous les modules du projet LumVorax, consulter :
> [`/home/lvx/LVX/lumvorax2/STANDARD_NAMES.md`](../../STANDARD_NAMES.md)
>
> Dernière mise à jour globale : C146 (30 avril 2026)
