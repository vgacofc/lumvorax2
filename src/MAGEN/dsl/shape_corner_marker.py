...
# CORRECTION SESSION 56: Import fonctions validation depuis GlobalErrorHandler
from core.global_error_handler import validate_grid_access, safe_grid_slice
...
def mark_shape_corners(grid: np.ndarray, target_color: int = 8, mark_color: int = 1) -> np.ndarray:
    ...
    for shape_id in range(1, num_features + 1):
        ...
        if corner is not None:
            i, j = corner
            # CORRECTION SESSION 56: Utiliser validate_grid_access au lieu de validate_bounds
