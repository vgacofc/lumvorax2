"""
MAGEN Agent Complet - Architecture Systémique 7 Couches
...
- Couche 6: IntelligentExploration (curiosité dirigée)
...
class MAGENAgentComplete7Layers:
    ...
    def __init__(self, verbose: bool = True):
        ...
        # Couche 6: IntelligentExploration
        ...
        if self.verbose:
            print("✓ Couche 6: IntelligentExploration initialisé")
...
def train_agent(num_episodes: int = 10, max_steps: int = 100, verbose: bool = True):
    """
    Entraîne agent sur plusieurs épisodes
    
    Args:
        num_episodes: Nombre épisodes
        max_steps: Steps max par épisode
        verbose: Affichage détaillé
    """
    print("="*60)
    print("ENTRAÎNEMENT MAGEN - ARCHITECTURE 7 COUCHES COMPLÈTE")
    print("="*60)
