...
class NX47_VESU_Production:
    ...
    def __init__(self, input_dir=None, output_dir=None):
        self.version = "NX-47 VESU PROD V136-REAL-PY"
        ...
        self.roadmap_path = os.path.join(self.output_dir, "v136_roadmap_realtime.json")
        self.execution_log_path = os.path.join(self.output_dir, "v136_execution_logs.json")
        self.metadata_path = os.path.join(self.output_dir, "v136_execution_metadata.json")
